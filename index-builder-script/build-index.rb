...
HERE
      ...
      subdir.each do |subpath|
          if subpath =~ /.*otml$/
            ...
            otml_launchers += "<tr><td width=200><b><a href=#{subpath}>#{subpath}</a></b></td><td width=100><a href=""#{jnlp_url}"">learner mode</a></td><td width=100><a href=#{jnlp_author_url}>author mode</a></td><td width=100><a href=#{trac_otml_url}>rev #{svn_status_arr[1]} #{svn_status_arr[2]}</a></td></tr>"
          end
