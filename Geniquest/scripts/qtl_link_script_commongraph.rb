  ...
  if ($selectedDrakes.size == 2)
    ...
    if ($remainingBudget.value > 0)
      ...
      if $selectedDrakeStrains.include?("Mountain") && $selectedDrakeStrains.include?("Valley") 
        ...
        $QTLLabels[64].setVerticalVisible(true)      elsif $selectedDrakeStrains.include?("Mountain") && $selectedDrakeStrains.include?("Swamp")
...
_      elsif $selectedDrakeStrains.include?("Valley") && $selectedDrakeStrains.include?("Desert")
        puts "Swamp"
